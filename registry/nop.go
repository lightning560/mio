...
func (n Local) RegisterService(ctx context.Context, si *server.ServiceInfo) error {
	log.Info("register service locally", log.FieldMod("registry"), log.FieldName(si.Name), log.FieldAddr(si.Label()))
	return nil
}

// UnregisterService ...
func (n Local) UnregisterService(ctx context.Context, si *server.ServiceInfo) error {
	log.Info("unregister service locally", log.FieldMod("registry"), log.FieldName(si.Name), log.FieldAddr(si.Label()))
	return nil
}
