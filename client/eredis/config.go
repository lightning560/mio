...
type config struct {
	...
	Debug                       bool          // Debug开关， 是否开启调试，默认不开启，开启后并加上export MIO_DEBUG=true，可以看到每次请求，配置名、地址、耗时、请求数据、响应数据
	...
	EnableLocalCacheInterceptor bool          // 是否开启本地缓存
...
func DefaultConfig() *config {
	return &config{
		...
		EnableLocalCacheInterceptor: false,
