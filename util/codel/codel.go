...
var (
	_limitExceedError = errors.New(509, "LimitExceedError", "codel LimitExceedError")
	_deadlineError    = errors.New(504, "DeadlineError", "codel DeadlineError")
)
